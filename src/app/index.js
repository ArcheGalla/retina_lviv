angular.module('app', ['ngMask', 'pascalprecht.translate']).controller('MainController', [
  '$scope', '$translate', '$window', function($scope, $translate) {
  ...
  .translations('en', {
    ...
    "INTRO_TEXT_2": "The Symposium will be held April 27-28, 2018 in the city of Lviv, Ukraine.",
    "INTRO_TEXT_3": "In addition to the scientific program, excursions for accompanying persons (the ­­­day of the conference) and for all participants on the day following the conference (Sunday, April 29), are foreseen. Some information about Lviv you can find in the next sites:",
    ...
    "PAY_OPTIONS_1_3": "",
    "PAY_OPTIONS_3": "After you pass Step 1, our manager will contact you and send a payment document on your e-mail. You should print it and make payment in the bank. After completing the given items our manager will contact you once more for final confirmation of your participation in the symposium ",
    ...
    "MAIN_DESCRIPTION_PREVIOUS": "Retina Liv 2016",
    ...
    "INTRO_TEXT_3": "Крім наукової програми, пропонуємо екскурсійний план для супроводжуючих осіб (у день конференції) та для всіх учасників конференції на наступний день (неділя, 29 квітня)",
