angular.module('app', ['ngMask', 'pascalprecht.translate']).controller('MainController', [
  ...
  .translations('en', {
    ...
    "INTRO_TEXT_3": "In addition to the scientific program, excursions for accompanying persons (the ­­­day of the conference) and for all participants on the day following the conference (Sunday, May 6), are foreseen. Some information about Lviv you can find in the next sites:",
    ...
    "INTRO_TEXT_2": "Симпозіум відбудеться 4-5 травня 2018 року у місті Львів, Україна.",
